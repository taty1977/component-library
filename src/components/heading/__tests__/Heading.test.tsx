...
describe('Heading', () => {
  ...
  test('supports selectable text decoration', () => {
    renderWithTheme(<Heading textDecoration='underline'>Section title</Heading>)

    expect(screen.getByRole('heading', { name: 'Section title' })).toHaveStyle('text-decoration: underline')
  })
})
